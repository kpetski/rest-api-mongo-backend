...
*/
var aa=__webpack_require__(1),m=__webpack_require__(9),A=__webpack_require__(4),B=__webpack_require__(2),ca=__webpack_require__(10),da=__webpack_require__(11),ea=__webpack_require__(12),ha=__webpack_require__(13),ia=__webpack_require__(14),C=__webpack_require__(5);
...
const React = __webpack_require__(1);
const ReactDOM = __webpack_require__(3);
const List = __webpack_require__(28);
const Header = __webpack_require__(29);
const Input = __webpack_require__(30);
...
class Wrapper extends React.Component {
    ...
    render() {
        ...
        return React.createElement(
            'div',
            null,
            React.createElement(Header, { title: 'CRUD Messages App' }),
            React.createElement(Input, { messageSubmitted: this.messageSubmitted }),
...
class List extends React.Component {
    ...
    componentDidMount() {
        ...
        if (typeof fetch !== 'undefined') {
            ...
            fetch('http://localhost:3000/messages/').then(response => response.json()).then(json => {
    ...
    getTable() {
        ...
        let tableBody = React.createElement(
            'tbody',
            null,
            this.getTableRows()
        );
        ...
        const table = React.createElement(
            'table',
            { className: 'table padding-left-medium padding-right-medium side-borders-none' },
            tableHead,
            tableBody
        );
    ...
    render() {
        return React.createElement(
            'div',
            null,
            this.state.isError === false && this.getTable(),
            this.state.isError === true && React.createElement(
                'div',
                { className: 'notification-box alert' },
                this.state.data
            )
        );
    }
...
class Header extends React.Component {
    render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                'div',
                { className: 'columns padding-vert-large padding-horiz-xlarge text-center' },
                React.createElement(
                    'h3',
                    { className: 'text-white padding-vert-large padding-horiz-xlarge' },
                    'CRUD Messages App'
                )
            )
        );
...
class Input extends React.Component {
    ...
    render() {
        return React.createElement(
            'div',
            { className: 'bg-off-white padding-medium' },
            React.createElement(
                'div',
                { className: 'row' },
                React.createElement(
                    'div',
                    { className: 'large-12 columns md-text-field with-floating-label' },
                    React.createElement('input', { type: 'text', id: 'name', required: true }),
                    React.createElement(
                        'label',
                        { htmlFor: 'name' },
                        'Name'
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'md-textarea-field with-floating-label md-textarea--autoresize' },
                        React.createElement('textarea', { 'data-autoresize': '', rows: '1', type: 'text', id: 'message', required: true }),
                        React.createElement(
                            'label',
                            { htmlFor: 'message' },
                            'Message'
